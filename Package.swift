...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-4.2.0-rc.34.xcframework.zip",
			checksum: "ad8bcc27b1da369a6f73ea6b60385da0695e76ad1e36c385c818e9947fdaee60"
		)
	]
)