...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-3.2.0-rc.10.xcframework.zip",
			checksum: "6415e31c9b8bbe245c9f919effd3cfc562e136dedbdf59d62250e18140b06ca3"
		)
	]
)