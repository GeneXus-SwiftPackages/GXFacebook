...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFacebook-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "29c5d34c69c4794a4756fd2622815358d1dbf1f73dc51e0211ea35716f313e08"
		)
	]
)