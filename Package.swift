...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-4.2.0-rc.20.xcframework.zip",
			checksum: "e0fc3ead053343dc322ed1ce8a45b5236033c0b078eb40489add0d265de237b0"
		)
	]
)