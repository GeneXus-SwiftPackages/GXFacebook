...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-4.2.0-rc.37.xcframework.zip",
			checksum: "39f0fb269b681831f22cecce9b33e9a3e92070b3f78cc0c9276596d4a31728a9"
		)
	]
)