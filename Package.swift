...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-2.0.0-rc.34.xcframework.zip",
			checksum: "e9e0e3b67f905740bdd86e602ec525a43652970d5fff636f1115067023c7b47f"
		)
	]
)