...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-3.2.0-rc.11.xcframework.zip",
			checksum: "33822e132daef93f1e43066266e6c22405129dc146b4239a97a23aa242e1808d"
		)
	]
)