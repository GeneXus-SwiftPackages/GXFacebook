...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-3.2.0-rc.12.xcframework.zip",
			checksum: "929c2e7a7e54a7dfcf6b1fe201ac04ad60299b054b9aab56b38eb4740fc03feb"
		)
	]
)