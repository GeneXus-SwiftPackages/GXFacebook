...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-2.0.0-rc.36.xcframework.zip",
			checksum: "2cd97af97b7fc6937e252616101257412e7ceffc2319bcd4fff2234cd0d110da"
		)
	]
)