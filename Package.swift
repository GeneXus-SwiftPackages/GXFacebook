...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-4.2.0-rc.13.xcframework.zip",
			checksum: "97b31b6c4f7ac1d7e9fc56fab4d658986b360ecac49d1a6359442fecc765f3ba"
		)
	]
)