...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-2.0.0-rc.32.xcframework.zip",
			checksum: "343989a932b4e86e27fc2eb1f467c8fa2302c5c68dc08d290f49bdfa011a5be1"
		)
	]
)