...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-4.1.0-rc.25.xcframework.zip",
			checksum: "46ba3adec372aa6847a849a8f5f6fd399db1362b4825ce8afbb62b6f92c8b811"
		)
	]
)