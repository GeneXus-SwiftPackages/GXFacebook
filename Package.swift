...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-4.1.0-rc.14.xcframework.zip",
			checksum: "c2ed3fd750f0f8fb04b2dd5c88959c249cfc5c965ec528320b85a3aba0f3d4ff"
		)
	]
)