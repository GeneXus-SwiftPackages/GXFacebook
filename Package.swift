...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-2.0.0-rc.22.xcframework.zip",
			checksum: "99820a9393fa88718e9dde586bb2b212ea68643dc065bd92cbc5c74a7c2faf88"
		)
	]
)