...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFacebook",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFacebook-3.2.0-rc.13.xcframework.zip",
			checksum: "5ce60e55f38f05d3a3750b89f6f5f7434995e3201242cee7a9b411df61125f7d"
		)
	]
)